  ...
  proyectos: { titulo: string; descripcion: string; imagen: string; web: string; repo: string }[] =
    [
      ...
      },
      {
        ...
        imagen: 'assets/img_proyectos/To-do-list-Frontend.webp',
      ...
      },
      {
        ...
        imagen: 'assets/img_proyectos/To-do-list-Backend.webp',
        web: '',
      ...
      },
      {
        ...
        imagen: 'assets/img_proyectos/Soporte-Tecnico-App.webp',
      ...
      },
      {
        ...
        imagen: 'assets/img_proyectos/Primer_Juego_En_Godot.webp',
        web: '',
      ...
      },
      {
        ...
        imagen: 'assets/img_proyectos/Juego_De_Memoria.webp',
      ...
      },
      {
        ...
        imagen: 'assets/img_proyectos/Servlet_Inicio.webp',
        web: '',
      ...
      },
      {
        ...
        imagen: 'assets/img_proyectos/Gestion_FCT_Nodejs.webp',
        web: '',
      ...
      },
      {
        ...
        imagen: 'assets/img_proyectos/Gestion_Profesores_PHP.webp',
        web: '',
      ...
      },
      {
        ...
        descripcion: 'Un juego hecho con HTML, CSS y JavaScript.',
        imagen: 'assets/img_proyectos/Conecta4.webp',
      ...
      },
      {
        ...
        imagen: 'assets/img_proyectos/Calculadora.webp',
      ...
      },
      {
        ...
        imagen: 'assets/img_proyectos/Hola_Mundo.webp',
